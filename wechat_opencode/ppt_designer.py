...
3. 完成后 → [结果: 成功 PPT已保存到xxx.pptx] 或 [结果: 失败 原因]
...
def get_designer_prompt() -> str:
    """Return the full PPT designer system prompt with themes."""
    return PPT_DESIGNER_PROMPT.format(themes=format_themes_for_prompt())
